package `in`.runo.dialer.adapters
...
import `in`.runo.dialer.extensions.areMultipleSIMsAvailable
import `in`.runo.dialer.extensions.callContactWithSim
import `in`.runo.dialer.extensions.config
import `in`.runo.dialer.extensions.startContactDetailsIntent
