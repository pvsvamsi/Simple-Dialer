...
import `in`.runo.dialer.BuildConfig
import `in`.runo.dialer.R
import `in`.runo.dialer.adapters.ViewPagerAdapter
import `in`.runo.dialer.dialogs.ChangeSortingDialog
import `in`.runo.dialer.extensions.config
import `in`.runo.dialer.extensions.launchCreateNewContactIntent
import `in`.runo.dialer.fragments.FavoritesFragment
import `in`.runo.dialer.fragments.MyViewPagerFragment
import `in`.runo.dialer.helpers.OPEN_DIAL_PAD_AT_LAUNCH
import `in`.runo.dialer.helpers.RecentsHelper
import `in`.runo.dialer.helpers.tabsList
